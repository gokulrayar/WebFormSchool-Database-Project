            ...
            <p>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataKeyNames="CourseId"  GridLines="None">
                    <Columns>
                        ...
                        <asp:BoundField DataField="CourseHours" HeaderText="CourseHours" SortExpression="CourseHours" />
                    </Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolmanagementConnectionString4 %>" ProviderName="<%$ ConnectionStrings:SchoolmanagementConnectionString4.ProviderName %>" SelectCommand="SELECT [CourseId], [CourseName], [CourseCode], [Hours] FROM [Courses]"></asp:SqlDataSource>
</p>
</asp:Content>
